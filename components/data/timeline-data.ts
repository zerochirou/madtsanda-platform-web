...
export const timelineMilestones: TimelineMilestone[] = [
  ...
  {
    year: "1990",
    title: "Perubahan Nama Resmi",
    description:
      "MTs Negeri Kediri II resmi berganti nama menjadi MTsN 2 Kota Kediri sesuai keputusan Kementerian Agama. Perubahan ini memperkuat identitas madrasah di kancah pendidikan nasional.",
    imageSrc: "/images/gallery/gedung-timur.webp",
    imageAlt: "Gedung MTsN 2 Kota Kediri",
  },
  {
    year: "2005",
