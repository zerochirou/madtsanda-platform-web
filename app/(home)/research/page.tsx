...
export default async function ResearchPage({
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black text-foreground">
      ...
      <div className="relative min-h-screen flex items-center overflow-hidden dark:bg-black dark:text-white">
        ...
        <div className="absolute right-0 top-1/2 -translate-y-1/2 hidden lg:block">
          <div className="relative h-130 w-130">
            ...
            {/*<Image
              ...
              width={100}
              height={100}
              className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-[140px] opacity-90 drop-shadow-[0_0_60px_#10b981]"
            />*/}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 pt-16 pb-24 md:pb-32 grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="inline-flex items-center gap-2 rounded-full border border-emerald-500/30 bg-emerald-500/10 px-4 py-1 text-sm text-emerald-400">
            ...
            <p className="max-w-200 text-xl text-zinc-400">
              Gerbang Anda menuju 1000+ makalah yang ditinjau sejawat, studi
              terobosan, dan wawasan visioner yang membentuk masa depan
              teknologi dan sains.
            </p>
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              ...
              <Button
                size="lg"
                variant="outline"
                className="h-14 px-8 border-white/30 dark:text-white text-black hover:text-emerald-500  hover:bg-white/10 text-base"
              >
                Submit Paper
              </Button>
              </Link>
        ...
        <div className="absolute bottom-0 left-0 right-0 border-t border-white/10 dark:bg-black/70 dark:backdrop-blur-xl">
          <div className="max-w-7xl mx-auto px-6 py-8 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm text-zinc-400 mt-1 tracking-[1px]">
                RESEARCH PAPERS
              </p>
            </div>
            <div className="flex flex-col items-center border-l border-white/10 md:border-l">
              <div className="flex items-center gap-3 text-emerald-400">
                ...
                <span className="text-5xl font-semibold tabular-nums tracking-tighter whitespace-pre-wrap">
                  <NumberTicker value={24000} className="dark:text-white" />
                </span>
              </div>
              <p className="text-sm text-zinc-400 mt-1 tracking-[1px]">
                TOTAL DOWNLOADS
            ...
            <div className="flex flex-col items-center border-l border-white/10 md:border-l">
              <div className="flex items-center gap-3 text-emerald-400">
                ...
                <span className="text-5xl font-semibold tabular-nums tracking-tighter whitespace-pre-wrap text-white">
                  <NumberTicker value={98000} className="dark:text-white" />
                </span>
              </div>
              <p className="text-sm text-zinc-400 mt-1 tracking-[1px]">
                ACTIVE RESEARCHERS
      ...
      <div id="research-library" className="max-w-7xl mx-auto px-6 py-20">
