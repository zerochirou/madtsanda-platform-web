          ...
          <Card className="relative overflow-hidden border-emerald-200/80 bg-white/75 dark:bg-zinc-950 shadow-2xl shadow-emerald-900/10 backdrop-blur-xl">
            ...
            <CardContent className="relative flex flex-col items-center px-5 pb-8 pt-10 text-center sm:px-8">
              ...
              >
                ...
                <motion.div
                  className="absolute -bottom-5 left-1/2 flex -translate-x-1/2 items-center gap-2 rounded-full border border-emerald-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 px-4 py-2 text-sm font-semibold text-emerald-700 dark:text-emerald-400 shadow-xl"
