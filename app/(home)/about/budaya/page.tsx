...
export default function BudayaPage() {
  return (
    <main className="mt-20 min-h-screen bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-white transition-colors duration-300">
      {/* ==================== HERO ==================== */}
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 bg-linear-to-br from-emerald-900 via-emerald-950 to-zinc-950" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(16,185,129,0.15),transparent_60%)]" />

        <div className="relative z-10 mx-auto max-w-7xl px-6 py-20 lg:py-28 text-center">
          <motion.div
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-black tracking-tight text-white">
              ...
              <span className="relative inline-block text-emerald-300">
                Madrasah Kami
                <span className="absolute -bottom-2 left-0 h-1.5 w-full rounded-full bg-amber-400" />
              </span>
            </h1>
            <p className="mt-6 max-w-2xl mx-auto text-lg text-emerald-100/70">
              Empat pilar esensial yang berorientasi pada perwujudan karakter
              siswa yang beraqidah kuat, beribadah benar, berakhlak karimah,
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:py-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="group relative overflow-hidden rounded-3xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-8 lg:p-10 hover:border-emerald-300 dark:hover:border-emerald-700 transition-all duration-300 hover:shadow-xl hover:shadow-emerald-500/5"
          >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="group relative overflow-hidden rounded-3xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-8 lg:p-10 hover:border-amber-300 dark:hover:border-amber-700 transition-all duration-300 hover:shadow-xl hover:shadow-amber-500/5"
          >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="md:col-span-2 relative overflow-hidden rounded-3xl bg-emerald-900 dark:bg-emerald-950 border border-emerald-800 p-8 lg:p-10"
          >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="md:col-span-2 group relative overflow-hidden rounded-3xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-8 lg:p-10 hover:border-violet-300 dark:hover:border-violet-700 transition-all duration-300 hover:shadow-xl hover:shadow-violet-500/5"
          >
